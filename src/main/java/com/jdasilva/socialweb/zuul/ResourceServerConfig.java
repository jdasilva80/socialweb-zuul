...
//				.antMatchers(HttpMethod.DELETE, "/api/socialweb/**", "/api/socialweb-usuarios/usuarios").hasAnyRole("ADMIN")
				.antMatchers(HttpMethod.GET, "/api/socialweb/**", "/api/socialweb-usuarios/usuarios").permitAll()
				.antMatchers(HttpMethod.POST, "/api/socialweb/**", "/api/socialweb-usuarios/usuarios").permitAll()
				.antMatchers(HttpMethod.PUT, "/api/socialweb/**", "/api/socialweb-usuarios/usuarios").permitAll()
				.antMatchers(HttpMethod.DELETE, "/api/socialweb/**", "/api/socialweb-usuarios/usuarios").permitAll()
				.antMatchers("/api/socialweb-reclamaciones/reclamaciones-v2/**").permitAll()
				.antMatchers("/api/socialweb-reclamaciones/reclamaciones/**").permitAll()
				.antMatchers("/api/socialweb-productos/productos/**").permitAll()
				.antMatchers("/api/socialweb-productos/apirest/productos/**").permitAll()
				.antMatchers("/api/socialweb-tienda/tienda/**").permitAll()				
				.antMatchers("/api/socialweb-reclamaciones/resultado/reclamaciones/**").permitAll()
				.antMatchers("/api/socialweb-usuarios/usuarios/{id}").permitAll()
